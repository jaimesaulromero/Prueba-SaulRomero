...
<body>
<h3 class="display-1 text-center"> Lista de usuarios dados de alta en el sistema </h3>
<div class="container mt-4">
    <div class="d-flex justify-content-end">
        <a href="<?php echo site_url('/user-form') ?>" class="btn btn-success lg-6">Agregar usuario </a>
	</div>
    <?php
